...
class TopicResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Gestionar Temas';
            ...
            ->schema([
                Grid::make(['default' => 0])->schema([
                    ...
                    Forms\Components\Select::make('moderated')
                        ->label('Estado do Tema')
                        ->hint('<strong>Predeterminado:</strong> Pendente')
                        ->options([
                            'closed' => 'Fechado',
                            'moderated' => 'Moderado',
                            'pending' => 'Pendente',
                    ...
                    Forms\Components\Toggle::make('status')
                        ->hint('<strong>Predeterminado:</strong> Fixo')
                        ->label('Tema ativo'),
                ])
            ]);
    }

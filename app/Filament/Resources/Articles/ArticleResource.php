...
class ArticleResource extends Resource
{
    ...
    protected static ?string $navigationGroup = 'Noticias';

    protected static ?string $navigationLabel = 'Gestionar Noticias';
            ...
            ->schema([
                Grid::make(['default' => 0])->schema([
                    ...
                    Forms\Components\TextInput::make('image_path')
                        ->label('URL da Imagem')
                        ->required()
                        ->helperText('Recomendado: 1200 x 630 px. Usa URL completa (https://...) o ruta local (/images/... o storage/...).'),

        ...
        <ul class="principal-list">
            ...
            @php
                ...
                $fixedPathsByLabel = [
                    'inicio' => '/',
                    'home' => '/',
                    'habboacademy' => '/pages/todas-las-noticias',
                    'habbo academy' => '/pages/todas-las-noticias',
                    'habble' => '/pages/todas-las-noticias',
                    'placas' => '/pages/placas',
                    'habbo' => '/pages/placas',
                    'contenidos' => '/pages/todas-las-noticias',
                    'conteudos' => '/pages/todas-las-noticias',
                    'contents' => '/pages/todas-las-noticias',

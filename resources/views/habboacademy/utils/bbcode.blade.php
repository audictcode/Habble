<button type="button" data-toggle="tooltip" data-bbcode-el="{{ $element; }}" data-bbcode-before="[b]" data-bbcode-after="[/b]" data-bbcode title="Negrita">
    <i class="fa fa-bold ">
    </i>
</button>
<button type="button" data-toggle="tooltip" data-bbcode-el="{{ $element; }}" data-bbcode-before="[i]" data-bbcode-after="[/i]" data-bbcode title="Cursiva">
...
<button type="button" data-toggle="tooltip" data-bbcode-el="{{ $element; }}" data-bbcode-before="[s]" data-bbcode-after="[/s]" data-bbcode title="Tachado">
    <i class="fa fa-strikethrough ">
    </i>
</button>
@if ($type === 2)
<button type="button" data-toggle="tooltip" data-bbcode-el="{{ $element; }}" data-bbcode-before="[img]" data-bbcode-after="[/img]" data-bbcode title="Insertar imagen">
    <i class="far fa-image ">
    </i>
</button>
@endif
<button type="button" data-toggle="tooltip" data-bbcode-el="moreButtons" data-type="colors{{ explode('#', $element)[1] }}" data-bbcode title="Colores de texto">
    <i class="fa fa-tint">
    </i>
...
<button type="button" data-toggle="tooltip" data-bbcode-el="{{ $element; }}" data-bbcode-before="[url=LINK]" data-bbcode-after="[/url]" data-bbcode title="Insertar URL">
        <i class="fa fa-link"></i>
    </button>
    <button type="button" data-toggle="tooltip" data-bbcode-el="{{ $element; }}" data-bbcode-before="[youtube]" data-bbcode-after="[/youtube]" data-bbcode title="Insertar video">
    ...
    <button type="button" data-toggle="tooltip" data-bbcode-el="moreButtons" data-type="fontSize{{ explode('#', $element)[1] }}" data-bbcode title="Tamaño de texto">
        <i class="fa fa-font"></i>
        <i class="fa fa-chevron-down" style="font-size: 7px; opacity: 0.5;"></i>
    </button>
    <div class="moreButtons" id="fontSize{{ explode('#', $element)[1] }}">
        <button type="button" data-bbcode-el="{{ $element; }}" data-bbcode-before="[size=1]" data-bbcode-after="[/size]" data-bbcode>Muy pequeña
        </button>
        <button type="button" data-bbcode-el="{{ $element; }}" data-bbcode-before="[size=2]" data-bbcode-after="[/size]" data-bbcode>Pequeña
        </button>
...
<div class="moreButtons" id="emoji{{ explode('#', $element)[1] }}">
    <button type="button" data-bbcode-el="{{ $element; }}" data-toggle="tooltip" data-bbcode-before="[emoji=iloved]" class="emoji" data-bbcode-after="" data-bbcode title="Me encantó">
        <img src="/images/emojis/iloved.webp" />
    </button>
    <button type="button" data-bbcode-el="{{ $element; }}" data-toggle="tooltip" data-bbcode-before="[emoji=drooling]" class="emoji" data-bbcode-after="" data-bbcode title="Babeando">
        <img src="/images/emojis/drooling.webp" />
    </button>
    <button type="button" data-bbcode-el="{{ $element; }}" data-toggle="tooltip" data-bbcode-before="[emoji=kiss]" class="emoji" data-bbcode-after="" data-bbcode title="Besito">
    ...
    <button type="button" data-bbcode-el="{{ $element; }}" data-toggle="tooltip" data-bbcode-before="[emoji=bold]" class="emoji" data-bbcode-after="" data-bbcode title="Presumido">
        <img src="/images/emojis/bold.webp" />
    </button>
    <button type="button" data-bbcode-el="{{ $element; }}" data-toggle="tooltip" data-bbcode-before="[emoji=sleeping]" class="emoji" data-bbcode-after="" data-bbcode title="Llorando">
        <img src="/images/emojis/sleeping.webp" />
    </button>
    <button type="button" data-bbcode-el="{{ $element; }}" data-toggle="tooltip" data-bbcode-before="[emoji=embarrassed]" class="emoji" data-bbcode-after="" data-bbcode title="Avergonzado">
        <img src="/images/emojis/embarrassed.webp" />
    </button>
    <button type="button" data-bbcode-el="{{ $element; }}" data-toggle="tooltip" data-bbcode-before="[emoji=sleeping]" class="emoji" data-bbcode-after="" data-bbcode title="Durmiendo">
        <img src="/images/emojis/sleeping.webp" />
    </button>
    ...
    <button type="button" data-bbcode-el="{{ $element; }}" data-toggle="tooltip" data-bbcode-before="[emoji=wink]" class="emoji" data-bbcode-after="" data-bbcode title="Guiño">
        <img src="/images/emojis/wink.webp" />
    </button>
    <button type="button" data-bbcode-el="{{ $element; }}" data-toggle="tooltip" data-bbcode-before="[emoji=happy]" class="emoji" data-bbcode-after="" data-bbcode title="Riendo">
        <img src="/images/emojis/happy.webp" />
    </button>
    <button type="button" data-bbcode-el="{{ $element; }}" data-toggle="tooltip" data-bbcode-before="[emoji=rage]" class="emoji" data-bbcode-after="" data-bbcode title="Rabia">

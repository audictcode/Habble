...
if (! function_exists('academyMediaUrl')) {
    /**
     * Resolve media paths stored in DB to a renderable URL.
     *
     * Supports:
     * - Full external URLs (http/https)
     * - Protocol-relative URLs (//...)
     * - Local public storage paths (campaign/banners/..., storage/..., public/...)
     */
    function academyMediaUrl(?string $value): string
    {
